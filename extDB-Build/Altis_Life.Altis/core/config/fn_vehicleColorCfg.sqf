...
switch (_vehicle) do
{
	case "I_Heli_Transport_02_F":
	{
		...
		_ret =
		[
			["textures\Texture_Mohawk_0_Hull.paa","reb","textures\Texture_Mohawk_1_Fin_Door.paa","textures\Texture_Mohawk_2_Fuselage.paa"],
	...
	case "C_Hatchback_01_sport_F":
	{
		...
		[
			...
			["textures\uk_police_hatchback_co.paa","cop"],
			["textures\barbie.paa","civ"]
		];
	};
	...
	case "C_Offroad_01_F":
	{
		...
		[
			...
			["textures\uk_police_offroad_co.paa","cop"],
			["#(argb,8,8,3)color(0.6,0.3,0.01,1)","civ"],
			["textures\pickup_medic.paa","med"]
		];
	};
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\uk_police_suv_co.paa","cop"],
			["textures\suv_makaveli.paa","civ"],
			["textures\pickup_medic.paa","med"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\heli_med.paa","med"],
			["textures\celtscopter.paa","cop"]
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\swat_hunter.paa","cop","textures\hunter_back.paa"]
		];
	};
