...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","meth_1","corn_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["corn_1"]): {_gather = "corn"; _val = 1;};
	default {""};
};
//gather check??
