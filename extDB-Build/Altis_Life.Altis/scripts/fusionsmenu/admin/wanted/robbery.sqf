...
[[getPlayerUID (cursorTarget),name (cursorTarget),"211"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
hint format["you have added %1 to the wanted list for Robbery", name _Crim];
