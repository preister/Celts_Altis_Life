/*
	File: carryingAnIllegalFirearm.sqf
...
[[getPlayerUID (cursorTarget),name (cursorTarget),"213A"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
hint format["you have added %1 to the wanted list for Use of an illegal Firearm", name _Crim];
