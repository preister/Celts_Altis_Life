...
[[getPlayerUID (cursorTarget),name (cursorTarget),"103"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
hint format["you have added %1 to the wanted list for assaulting a police officer", name _Crim];
