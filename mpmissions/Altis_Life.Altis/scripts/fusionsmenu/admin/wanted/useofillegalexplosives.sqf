/*
	File: useofillegalexplosives.sqf
...
[[getPlayerUID (cursorTarget),name (cursorTarget),"208"],"life_fnc_wantedAdd",false,false] spawn life_fnc_MP;
hint format["you have added %1 to the wanted list for Use of Illegal Explosives", name _Crim];
